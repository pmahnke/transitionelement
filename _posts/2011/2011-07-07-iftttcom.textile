...
"_if *this* then *that*_":http://ifttt.com is a new service whose aim is to connect various web apps together via their APIs.  The concept is very simple, each site is a _channel_ and you can create tasks between any of them, for example:
...
I was going to share how I am using "ifttt.com":http://ifttt.com for the "St Margarets Community Website":http://www.stmgrts.org.uk a hyperlocal site I run.
...
h3. Saving #new Tweets to Pinboard
